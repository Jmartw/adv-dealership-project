...
public class SalesContract extends Contract{
    ...
    public SalesContract(String dateOfContract, String name, String email, String vehicleSold, double salesTax, double recordingFee, double processingFee, boolean financeOption) {
